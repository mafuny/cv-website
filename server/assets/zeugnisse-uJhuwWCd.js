...
//#region src/routes/zeugnisse.tsx?tsr-split=component
var berichteData = [
	{
		id: "bbzp_iba",
		title: "Zeugnisse BBZP IBA 2025-2026",
		date: "August 2025 - Juli 2026",
		documentUrl: new URL("../assets/pdf/diplomas/bbzp_iba.pdf", import.meta.url).href
	},
	{
		id: "diploma_college",
		title: "Junior-Bachelor-Diplom in Software Engineering",
		date: "September 2022 - Juni 2026",
		documentUrl: new URL("../assets/pdf/diplomas/diploma_college.pdf", import.meta.url).href
	},
	{
		id: "stellwerk",
		title: "Stellwerk 9",
		date: "26.05.2026",
		documentUrl: new URL("../assets/pdf/diplomas/stellwerk9.pdf", import.meta.url).href
	},
	{
		id: "multicheck",
		title: "Multicheck ICT",
		date: "14.02.2026",
		documentUrl: new URL("../assets/pdf/diplomas/multicheck.pdf", import.meta.url).href
	}
];
function PdfThumbnail({ fileUrl }) {
	...
	if (!pdfLib) return /* @__PURE__ */ jsx("div", {
		className: "w-full h-full bg-muted animate-pulse flex items-center justify-center",
		children: /* @__PURE__ */ jsx("span", {
			className: "text-xs text-muted-foreground",
			children: "Lade Vorschau..."
		})
	});
	const { Document, Page } = pdfLib;
	return /* @__PURE__ */ jsx("div", {
		className: "absolute inset-0 w-full h-full opacity-90 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex justify-center bg-white overflow-hidden",
...
function PdfModal({ data, onClose }) {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: isImage ? /* @__PURE__ */ jsx("div", {
					className: "w-full h-full rounded-xl overflow-auto flex items-center justify-center bg-white/5 p-4 shadow-inner",
					children: hasError ? /* @__PURE__ */ jsxs("div", {
						...
						}), /* @__PURE__ */ jsx("p", { children: "Bild konnte nicht geladen werden" })]
					}) : /* @__PURE__ */ jsx("img", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Hier finden Sie meine Zeugnisse und Bewertungen. Von Stellwerk 9 über Multicheck ICT bis hin zu meinen Junior-Bachelor-Diplomen. Klicken Sie auf ein Dokument, um es in voller Größe anzuzeigen."
						})
					]
				}), /* @__PURE__ */ jsx("div", {
					className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-[fadeUp_1s_ease-out_0.2s_both]",
					children: berichteData.map((bericht) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "relative w-full aspect-[1/1.4] mb-4 bg-white rounded-lg overflow-hidden border border-border/50 group-hover:border-accent/50 transition-colors duration-300 flex items-center justify-center",
								children: [isImage ? hasImageError ? /* @__PURE__ */ jsxs("div", {
									className: "absolute inset-0 w-full h-full bg-muted/10 flex flex-col items-center justify-center text-muted-foreground/40 border-2 border-dashed border-border/50 m-2 rounded-md",
									children: [/* @__PURE__ */ jsxs("svg", {
										width: "32",
										height: "32",
										viewBox: "0 0 24 24",
								...
								}) : /* @__PURE__ */ jsx(PdfThumbnail, { fileUrl: bericht.documentUrl }), /* @__PURE__ */ jsx("div", {
									className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-20 backdrop-blur-[2px]",
									children: /* @__PURE__ */ jsx("div", {
										className: "bg-accent text-white p-3 rounded-full transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 shadow-[0_0_20px_rgba(255,140,0,0.4)]",
										children: /* @__PURE__ */ jsxs("svg", {
											width: "20",
											height: "20",
											viewBox: "0 0 24 24",
								...
								children: [/* @__PURE__ */ jsx("h3", {
									className: "font-medium text-white group-hover:text-accent transition-colors duration-300 line-clamp-2",
									children: bericht.title
								}), /* @__PURE__ */ jsx("p", {
									className: "text-sm text-muted-foreground mt-1",
									children: bericht.date
								})]
							})]
						}, bericht.id);
					})
...
//#endregion
export { SchnupperPage as component };
