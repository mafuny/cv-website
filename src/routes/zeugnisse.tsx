...
// --- НАСТРОЙКА РОУТА ---
export const Route = createFileRoute("/zeugnisse")({
  head: () => ({
    meta: [
      { title: "Zeugnisse – Yaroslav Serbinov" },
      { name: "description", content: "Zeugnisse von Yaroslav Serbinov." },
    ],
  }),
    ...
    <main className="min-h-screen bg-background text-foreground relative">
      ...
      <div className="relative max-w-5xl mx-auto px-6 py-24 sm:py-32">
        <div className="mb-12 animate-[fadeUp_0.8s_ease-out]">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">Zeugnisse</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Hier finden Sie meine Zeugnisse und Bewertungen. Von Stellwerk 9 über Multicheck ICT bis hin zu meinen Junior-Bachelor-Diplomen. Klicken Sie auf ein Dokument, um es in voller Größe anzuzeigen.
          </p>
        </div>
